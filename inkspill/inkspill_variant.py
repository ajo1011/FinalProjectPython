...
def main():
    ...
    # Load images
    LOGOIMAGE = pygame.image.load('inkspill/inkspilllogo.png')
    SPOTIMAGE = pygame.image.load('inkspill/inkspillspot.png')
    SETTINGSIMAGE = pygame.image.load('inkspill/inkspillsettings.png')
    SETTINGSBUTTONIMAGE = pygame.image.load('inkspill/inkspillsettingsbutton.png')
    RESETBUTTONIMAGE = pygame.image.load('inkspill/inkspillresetbutton.png')
